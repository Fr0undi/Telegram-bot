...
Рисунки и таблицы:
- Рисунки по центру
- Подписи рисунков: "Рисунок N – ..." (по центру)
- Подписи таблиц: "Таблица N" (справа) + "Название" (по центру)
- Таблицы выравниваются по центру
- Содержимое таблиц: Times New Roman 14pt
...
Нумерация страниц:
- Снизу по центру
- Титульный лист считается как стр.1, но номер не показывается
...
- Подпись: "Рисунок N – Название" (по центру)
- Автоматическая нумерация

Таблицы:
- Подпись: "Таблица N" (справа)
- Название на следующей строке (по центру, замените на своё)
- Таблица выравнивается по центру
- Содержимое: Times New Roman 14pt
- Автоматическая нумерация
...
2. Проверьте таблицы - добавьте названия
3. Проверьте разбиение на страницы
4. Перепроверьте документ перед сдачей!
